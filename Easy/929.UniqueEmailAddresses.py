...
#Runtime: 48 ms, faster than 83.41% of Python3 online submissions for Unique Email Addresses.
#Memory Usage: 13.9 MB, less than 72.63% of Python3 online submissions for Unique Email Addresses.
