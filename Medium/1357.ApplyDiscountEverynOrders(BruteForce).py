...
#Runtime: 1104 ms, faster than 24.55% of Python3 online submissions for Apply Discount Every n Orders.
#Memory Usage: 21 MB, less than 93.94% of Python3 online submissions for Apply Discount Every n Orders.
...
class Cashier:
    ...
    def getBill(self, product: List[int], amount: List[int]) -> float:
        ...
        for i in range(len(product)):
            ...
            bill += amount[i] * self.prices[index]
